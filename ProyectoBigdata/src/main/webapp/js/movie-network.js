...
/* .......................................................................... */
  ...
  */
  function getMovieInfo( n ) {
	...
	info += '	</div>';
	info += '	<div style="float:left; width:54%; padding: 0 3% 0 3%">';
	info += '		<div style="width:100%; text-align:right">';
	info += '			<img src="./images/target.png" class="action" title="centrar nodo" onclick="selectMovie('+n.index+',true);"/>';
	info += '			<img src="./images/close.png" class="action" title="cerrar detalle" onClick="toggleDiv(\'movieInfo\');"/>'; 
	info += '		</div>';
	info += '		<br/>';
	info += '		<div style="clear: both;">';
		if( n.name )
		  info += '		<div class=f><span class=l>Name</span>: <span class=g>' 
			   + n.name + '</span></div>';
		if( n.country )
		  info += '		<div class=f><span class=l>Country</span>: <span class=d>' 
			   + n.country + '</span></div>';
		if( n.birth_date )
		  info += '		<div class=f><span class=l>Birth date</span>: <span class=c>' 
			   + n.birth_date + '</span></div>';
		if( n.description )
		  info += '		<div class=f><span class=l>Description</span>: ' + n.description 
			   + '		<a href="'+n.url+'" target="_blank"><span class=l style="margin-left:1em;">Ver+</span></a> ' 
			   + '</div>';
	info += '	</div>';
	info += '	</div>';
	info += '	</div>';	
